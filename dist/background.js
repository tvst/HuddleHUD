...
async function subscribe(url, tabId) {
  const cancelChildListener = (0,firebase_database__WEBPACK_IMPORTED_MODULE_1__.onChildAdded)(
    (0,firebase_database__WEBPACK_IMPORTED_MODULE_1__.query)(
      await getChannelRef(url),
      (0,firebase_database__WEBPACK_IMPORTED_MODULE_1__.limitToLast)(5),
    ),
...
async function getChannelPath(url) {
  const urlHash = md5__WEBPACK_IMPORTED_MODULE_2___default()(getCleanUrl(url))
...
async function getChannelRef(url) {
  return (0,firebase_database__WEBPACK_IMPORTED_MODULE_1__.ref)(db, await getChannelPath(url))
}


async function say({msgContents, url}) {
  (0,firebase_database__WEBPACK_IMPORTED_MODULE_1__.set)(
    (0,firebase_database__WEBPACK_IMPORTED_MODULE_1__.push)(await getChannelRef(url)),
    {
      nick: await getNick(),
      msgContents,
      timestamp: Date.now(),
...
function onNewMessage(snapshot, tabId) {
  ...
  if (msg.timestamp > Date.now() - A_WHILE_BACK) {
    ...
    (0,firebase_database__WEBPACK_IMPORTED_MODULE_1__.remove)(snapshot.ref)
  }
}
